...
public abstract class BaseController<E extends PageBean> extends
...
//    }
     ...
     * 分页模版
     */
    protected PageBean pager = new PageBean();
    /**
     * 抽象的业务逻辑层接口句柄，子类可以通过重写setServer方法注入指定的具体业务逻辑句柄来实现个性化需求
     */
    protected BaseService<E> server;
    protected E e;
...
//    protected abstract void selectListAfter();
     ...
     * @return
     */
    public BaseService<E> getServer() {
        return this.server;
    }

    public void setServer(BaseService<E> server) {
        this.server = server;
    }
...
//    }
     ...
     *            业务逻辑层对象
     * @param pm
     *            查询参数对象，此对象必须继承PageBean
     * @return PageBean
     * @throws Exception
     */
//    @RequestMapping("/selectPageBeanByServices")
//    public PageBean selectPageBeanByServices(Services services,
//                                                 PageBean pm) throws Exception {
...
//            offset = 0;
//        pm.setOffset(offset);
//        PageBean servicesPager = services.selectPageList(pm);
//        if (servicesPager == null)
//            servicesPager = new PageBean();
//        // 计算总页数
...
//        if (offset < 0)
//            offset = 0;
//        ((PageBean) getE()).setOffset(offset);
...
//        return selectList();
    ...
    public E selectOne() throws Exception {
